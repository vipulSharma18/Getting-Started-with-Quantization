...
# rtx4090
Profiling complete. Metrics: tokens per second (tps): 98.54814460204186, time to first token (ttft): 0.06283100204467773, time per output token (tpot): 0.00981784765625, prefill throughput: 95.49463159537011, decode throughput: 101.85558432123305, latency: 2.029470166015625, iterations: 5
GPU util: FLOPs (total generate flops/latency): 0.11709917931268092 TFLOPs, FLOP per token used (FLOPs/tps): 0.0011882433686149247 TFLOP/token, Bandwidth used (tps*model_size): 468.9889613987473 GB/s, Power used in last sample period: 172.405 W.
```
...
# sample results on rtx4090
Profiling complete. Metrics: tokens per second (tps): 75.05015381282566, time to first token (ttft): 0.06196264953613282, time per output token (tpot): 0.012998458251953124, prefill throughput: 96.83368191790737, decode throughput: 76.93223451417711, latency: 2.664885986328125, iterations: 5
GPU util: FLOPs (total generate flops/latency): 0.08917803316886011 TFLOPs, FLOP per token used (FLOPs/tps): 0.0011882458414578237 TFLOP/token, Bandwidth used (tps*model_size): 619.0620081520563 GB/s, Power used in last sample period: 178.697 W.
```
...
# rtx4090
Profiling complete. Metrics: tokens per second (tps): 97.253625310197, time to first token (ttft): 0.06577233810424805, time per output token (tpot): 0.009941892700195314, prefill throughput: 91.51164026017065, decode throughput: 100.6093902701011, latency: 2.0569105712890625, iterations: 5
GPU util: FLOPs (total generate flops/latency): 0.11553700690597626 TFLOPs, FLOP per token used (FLOPs/tps): 0.0011879969156672894 TFLOP/token, Bandwidth used (tps*model_size): 484.0397519001654 GB/s, Power used in last sample period: 150.55 W.
```
...
# rtx4090
Profiling complete. Metrics: tokens per second (tps): 77.90920014466252, time to first token (ttft): 0.06643286972045898, time per output token (tpot): 0.0124891416015625, prefill throughput: 90.99952198699333, decode throughput: 80.07764982548187, latency: 2.5673256347656253, iterations: 5
GPU util: FLOPs (total generate flops/latency): 0.09256686711722696 TFLOPs, FLOP per token used (FLOPs/tps): 0.001188137818708804 TFLOP/token, Bandwidth used (tps*model_size): 626.081862584185 GB/s, Power used in last sample period: 200.177 W.
```
...
# rtx4090
Profiling complete. Metrics: tokens per second (tps): 79.0712075708118, time to first token (ttft): 0.07727758178710939, time per output token (tpot): 0.012245168701171875, prefill throughput: 77.80089458682657, decode throughput: 81.66511814212413, latency: 2.5293751464843752, iterations: 5
GPU util: FLOPs (total generate flops/latency): 0.09395573100744391 TFLOPs, FLOP per token used (FLOPs/tps): 0.0011882420149370093 TFLOP/token, Bandwidth used (tps*model_size): 635.4198069136011 GB/s, Power used in last sample period: 190.908 W.
```
...
# rtx4090
Profiling complete. Metrics: tokens per second (tps): 87.00766782466152, time to first token (ttft): 0.07788235473632812, time per output token (tpot): 0.011087154296875, prefill throughput: 77.04176651127011, decode throughput: 90.19523297185944, latency: 2.298665869140625, iterations: 5
GPU util: FLOPs (total generate flops/latency): 0.10338574825964034 TFLOPs, FLOP per token used (FLOPs/tps): 0.0011882372076445495 TFLOP/token, Bandwidth used (tps*model_size): 414.06802666449937 GB/s, Power used in last sample period: 186.018 W.
```
...
# rtx4090
Profiling complete. Metrics: tokens per second (tps): 73.25036257062001, time to first token (ttft): 0.07733575744628907, time per output token (tpot): 0.013251031982421876, prefill throughput: 77.62321009654092, decode throughput: 75.46607744202888, latency: 2.73037021484375, iterations: 5
GPU util: FLOPs (total generate flops/latency): 0.08703921892643407 TFLOPs, FLOP per token used (FLOPs/tps): 0.0011882428410169349 TFLOP/token, Bandwidth used (tps*model_size): 604.2161707480042 GB/s, Power used in last sample period: 171.845 W.
```
