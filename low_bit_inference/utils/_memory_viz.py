...
if __name__ == "__main__":
    ...
    for cmd, description in plots:
        ...
        if cmd == "trace_plot":
            ...
            help = (
                ...
                "useful to reduce the number of events for large device_traces for debugging OOM"
            )
            trace_plot_a.add_argument(
    ...
    def _read(name):
        ...
        if isinstance(data, list):  # segments only...
            data = {"segments": data, "device_traces": []}
        return data
    ...
    if args.action == "segments":
        ...
        print(type(data['device_traces']), len(data['device_traces']))
        print(data['segments'])
        # print(trace(data))
