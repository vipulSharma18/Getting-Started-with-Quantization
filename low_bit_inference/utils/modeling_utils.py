...
from transformers.integrations import PeftAdapterMixin, deepspeed_config, is_deepspeed_zero3_enabled, is_fsdp_enabled
from transformers.integrations.accelerate import find_tied_parameters, init_empty_weights
...
from transformers.integrations.hub_kernels import is_kernel, load_and_register_kernel
...
from transformers.utils.generic import _CAN_RECORD_REGISTRY, GeneralInterface, OutputRecorder
